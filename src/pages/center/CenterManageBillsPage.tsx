...
import ManageBillsPage from '../admin/ManageBillsPage';
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', px: 3 }}>
        ...
        >
          View and manage bills for your center: <strong>{centerInfo.centerName}</strong>
        </Typography>

        <ManageBillsPage centerId={centerInfo.centerId} />
      </Box>
    </Box>
  );
};
