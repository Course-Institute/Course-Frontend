              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    transform: "scale(1.2)", // slight zoom for better blend
                  }}
                />
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <Fade in timeout={1000}>
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  Bridging the gap between education and employability through
                  hands-on practical training and industry-relevant curriculum
                </Typography>
              </Box>
            </Fade>
                ...
                <Slide direction="left" in timeout={1200}>
                  ...
                  >
                    <CardContent sx={{ p: 4 }}>
                      ...
                      >
                        At Mahavir Institute of Vocational & Paramedical
                        Association, we are committed to bridging the gap
                        between education and employability. Our focus goes
                        beyond classroom teaching — we emphasize hands-on
                        practical training, modern learning techniques, and
                      ...
                      >
                        Our institute offers over 100 specialized programs
                        across 9 major streams, including Paramedical Science,
                        Vocational Trades, Information Technology, Yoga &
                        Naturopathy, Fire Safety, Nursery Teacher Training
                        (NTT), Beauty & Wellness, Apparel Design, and
                        Agriculture.
                      </Typography>
                    </CardContent>
                  </Card>
                ...
                <Slide direction="right" in timeout={1200}>
                  ...
                  >
                    <CardContent sx={{ p: 4 }}>
                      ...
                      >
                        We believe that skill-based education has the power to
                        transform lives. That's why we provide an inclusive
                        learning environment where students from different
                        backgrounds can gain the knowledge, confidence, and
                        technical expertise required to succeed in today's
                      ...
                      >
                        ...
                        >
                          "Our goal is simple: to shape individuals into
                          professionals who create impact."
                        </Typography>
                      </Box>
                    </CardContent>
                  </Card>
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <Fade in timeout={1000}>
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  Discover your passion and build a successful career with our
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <Fade in timeout={1000}>
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  We provide the perfect environment for your educational and
                  career growth
                </Typography>
              </Box>
            </Fade>
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <Fade in timeout={1000}>
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  Recognized and accredited by leading educational bodies and
              ...
              {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((index) => (
                <Box key={index}>
                  <Slide direction="up" in timeout={1200 + index * 100}>
                    <Card
                      onClick={() =>
                        handleOpen(`/uploads/certification-${index}.jpg`)
                      }
                      sx={{ cursor: "pointer" }}
                    >
                      <Box
          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <Fade in timeout={1000}>
              <Box sx={{ textAlign: "center" }}>
                ...
                >
                  Take the first step toward a brighter future. Connect with our
                  admissions team to explore your best-fit program and career
                  opportunities.
                </Typography>
